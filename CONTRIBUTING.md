# Contributions, Support, and Issues for SimpleJSON

Contributions to the project are welcome. SimpleJSON is a free and open source software project, made open source with the hopes that the community would find ways to improve it.
...
- How to install SimpleJSON (explained in [README.md](README.md))
- How to use SimpleJSON as a dependency (explained in [README.md](README.md))
